...
if __name__ == '__main__':
    asyncio.run(connect_to_server("ws://rails-server:8080"))
    app.run(host="0.0.0.0", port=8081) # El modo debug muestra errores y reinicia automáticamente el servidor al hacer cambios
