...
WEMOS_IP = "192.168.1.70"
WEMOS_PORT = 4040
UDP_PORT = 12345  # Puerto UDP para el servidor
...
def connect_websocket(auth_tokens):
    ...
    websocket_url = f"ws://webserver:8080{WEBSOCKET_ENDPOINT}"
...
def start_udp_server(auth_tokens):
    ...
    while True:
        ...
        payload = json.dumps({"message": message, "ip": sender_ip, "port": sender_port})
        ws.send(payload)
